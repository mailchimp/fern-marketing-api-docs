...
You can also add an inbound domain with the API using the [`inbound/add-domain`](/transactional/api/inbound/add-domain) endpoint.
...
You can also do this via the API using the [`inbound/add-route`](/transactional/api/inbound/add-route) endpoint.

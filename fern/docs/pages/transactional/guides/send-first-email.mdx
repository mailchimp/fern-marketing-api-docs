...
<Note>
**Note**: You may at times be able to use the Marketing API where you might traditionally reach for transactional email. For more, see [Track Outside Activity with Events](/marketing/api/lists/list-member-events).
</Note>

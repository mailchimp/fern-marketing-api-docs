...
`https://api.mailchimp.com/3.0/campaigns?count=10&offset=10`**` `**
...
`https://api.mailchimp.com/3.0/campaigns?offset=0&count=10 `
...
`https://api.mailchimp.com/3.0/lists?fields=lists.name,lists.id `
...
`https://api.mailchimp.com/3.0/lists/{list_id}?fields=name `

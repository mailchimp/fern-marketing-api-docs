---
title: Creating and Organizing Products
description: Learn the structure of products and how to set up and manage them.
---
...
2. Add the option’s information as you would when [creating a top-level variant](/open-commerce/docs/creating-organizing-products/#configure-a-variant).

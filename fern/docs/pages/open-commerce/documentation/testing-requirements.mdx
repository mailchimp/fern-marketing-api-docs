...
description: Learn the rules for committing code to Open Commerce repos.
---
...
### [Mocking data](https://mailchimp.com/developer/open-commerce/docs/testing-requirements/#mocking-data)

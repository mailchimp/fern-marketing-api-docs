...
- A Mailchimp account
- [An API key and your server prefix](/marketing/build/get-started/generate-your-api-key),
...
access token and server prefix against your own user record.

The three URLs involved, if you're implementing this without the sample:
...
- Get the server prefix with a GET to `https://login.mailchimp.com/oauth2/metadata`, with the header `Authorization: OAuth USERS_OAUTH_TOKEN`

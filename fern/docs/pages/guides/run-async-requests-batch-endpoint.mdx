...
The signing scheme is identical to audience webhooks — see [Verifying webhook signatures](/marketing/guides/sync-audience-data-webhooks#verifying-webhook-signatures) for the full background. The examples below are adapted for the batch webhook context.

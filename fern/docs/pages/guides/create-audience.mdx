...
<Note>
**Note**: If you’re not sure whether or not a contact has already been added to an audience, you should use the [Add or update list member](/marketing/api/lists/upsert-member) endpoint. This will create the contact if it doesn’t already exist, or update a contact’s information if it does.
</Note>
...
- [Audiences/Lists API Reference](/marketing/api/lists/list)

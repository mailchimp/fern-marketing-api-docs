...
If you’re affected by this change, we recommend removing the `?apikey=` query parameter from your requests, and sending only an Authorization header following the [example in our Quick Start guide](/marketing/build/start-developing/send-your-first-api-request).

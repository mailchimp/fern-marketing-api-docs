...
We’ve added a new series of [Allowlists endpoints](/transactional/api/allowlist/allowlists-list) that are functionally identical to the Whitelists endpoints, but use new inclusive terminology instead. 

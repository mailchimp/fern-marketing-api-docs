...
We fixed a mistake in how the e-commerce API handled customers who did not opt-in to receiving marketing emails (e.g., when [adding an order](https://mailchimp.com/developer/api/marketing/ecommerce-orders/add-order/) via the API).

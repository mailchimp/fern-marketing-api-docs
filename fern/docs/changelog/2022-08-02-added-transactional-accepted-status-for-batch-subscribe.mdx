...
The [Batch Subscribe](https://mailchimp.com/developer/marketing/api/lists/batch-subscribe-or-unsubscribe/) endpoint now accepts ‘`transactional`’ as a possible status value.

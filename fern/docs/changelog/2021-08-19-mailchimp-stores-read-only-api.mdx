...
API requests for write operations (create, update, delete) to [E-Commerce Stores](/marketing/concepts/e-commerce#stores) representing Mailchimp Stores will respond with a 4XX error status.
